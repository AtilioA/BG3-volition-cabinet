...
Events.Extender.NetMessage = VCExtenderEventBase:CreateEvent("VCEventNetMessage", {
    ExtenderEvent = Ext.Events
        .NetMessage
})
...
function Events.Extender.NetMessage:CreateParams(e)
    return VCParams.NetMessage:New {
        Event = e,
        Channel = e.Channel,
        Message = e.Payload ~= "" and VCHelpers.Format:Parse(e.Payload) or ""
    }
end
